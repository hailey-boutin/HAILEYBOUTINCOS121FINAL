...
## Before Downloading ##
> This coding uses the "random" import
>
>Make sure you have downloaded the code **and** the dataset
>
>When running it on your own computer, make sure to copy the path of the dataset **on *your* computer**
...
>
>If the genre you are searching for is not in the database, you will get an error at the end that says:
>
...
>
>Just put in the genre you are searching for and if it is in the database you will receive the name of the game
>
>If the game is not in the database, you will receive the same prompt as if it is, but there will be nothing after the colon
>
